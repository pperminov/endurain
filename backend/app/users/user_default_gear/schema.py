...
class UserDefaultGearBase(BaseModel):
    """
    Base schema for user default gear assignments.
...
class UserDefaultGearRead(UserDefaultGearBase):
    """
...
class UserDefaultGearUpdate(UserDefaultGearRead):
    """
