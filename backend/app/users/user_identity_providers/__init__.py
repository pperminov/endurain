...
Exports:
    ...
    - Schemas: UserIdentityProviderBase, UserIdentityProviderCreate,
      UserIdentityProviderRead, UserIdentityProviderResponse,
      UserIdentityProviderTokenUpdate
    - Models: UserIdentityProvider (ORM model)
...
from .models import UserIdentityProvider as UserIdentityProviderModel
from .schema import (
